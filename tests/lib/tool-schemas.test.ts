...
describe('tool-schemas — structural invariants', () => {
  it('exports the expected count of tools (PR 12.1: 13 + PR 12.2 B-1: 3 SQL emitters + PR 3.3: 3 data-scanning tools + PR 3.4cd: 4 multi-agent answer tools + emit_tfm_metadata = 24)', () => {
