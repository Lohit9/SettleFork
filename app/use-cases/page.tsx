        ...
        <div className="max-w-5xl mx-auto py-24 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {USE_CASES.map((uc) => (
              <div
                key={uc.title}
                className="bg-white rounded-2xl p-8 border border-slate-200 hover:-translate-y-1 hover:shadow-xl transition-all duration-300"
              >
                <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center mb-4 text-lg">
                  {uc.icon}
                </div>
                <h2 className="text-xl font-bold text-slate-900 mb-2">{uc.title}</h2>
          ...
          <div className="mt-16 text-center">
            ...
            <a
              ...
              className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3.5 rounded-xl shadow-lg shadow-blue-600/20 hover:-translate-y-0.5 transition-all text-sm"
            >
              Book a Demo
            </a>
          </div>
